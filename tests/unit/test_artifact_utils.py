...
class TestBuildPreprocessingArtifact:
    ...
    def test_build_artifact_pipeline_type_is_correct(self, sample_scaler, sample_feature_names):
    ...
    def test_build_artifact_with_custom_values(self, sample_scaler, sample_feature_names):
...
class TestSavePreprocessingPipeline:
    ...
    def test_save_pipeline_creates_directories(self, sample_scaler, sample_feature_names):
...
class TestLoadPreprocessingPipeline:
    ...
    def test_load_pipeline_raises_error_for_invalid_dict(self, sample_scaler, sample_feature_names):
    ...
    def test_load_pipeline_raises_error_for_missing_keys(self, sample_scaler, sample_feature_names):
...
class TestTryLoadPreprocessingPipeline:
    ...
    def test_try_load_returns_dict_when_exists(self, sample_scaler, sample_feature_names):
    ...
    def test_try_load_never_raises_error(self):
        ...
        result = try_load_preprocessing_pipeline(input_path="/nonexistent/path/file.joblib")
